variable "parameters" {
  default = {
   ...
   // "shipping.dev.CART_ENDPOINT"  = { type = "String", value = "cart-dev.tadikonda.online:80" }
    ...
    "docdb.dev.schema_setup"   = { type  = "SecureString", value = "mongo --ssl --host dev-docdb-cluster.cluster-cec9yfajj5ic.us-east-1.docdb.amazonaws.com:27017 --sslCAFile rds-combined-ca-bundle.pem --username docdbadmin --password roboshop1234" }
    ...
    "shipping.dev.CART_ENDPOINT" = { type = "String" , value = "cart:80" }
    "shipping.dev.DB_HOST"        = { type = "String", value = "dev-mysql-rds-cluster.cluster-cec9yfajj5ic.us-east-1.rds.amazonaws.com" }
